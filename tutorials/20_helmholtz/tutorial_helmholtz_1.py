...
# @ExactStabilityFactor() # TODO enable
...
mesh = Mesh("data/helmholtz_1.xml")
subdomains = MeshFunction("size_t", mesh, "data/helmholtz_1_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/helmholtz_1_facet_region.xml")

# 2. Create Finite Element space
V = FunctionSpace(mesh, "Lagrange", 2)

# 3. Allocate an object of the Helmholtz class
...
reduced_basis_method.set_tolerance(1e-4, SCM=1e-4)

# 5. Perform the offline phase
reduced_basis_method.initialize_training_set(100, SCM=150)
